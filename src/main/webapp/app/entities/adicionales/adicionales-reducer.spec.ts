...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ADICIONALES_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ADICIONALES actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ADICIONALES actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ADICIONALES actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ADICIONALES actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ADICIONALES actions', async () => {
      const arg = 42666;
