...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './opciones.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_OPCIONES_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_OPCIONES actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_OPCIONES actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_OPCIONES actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_OPCIONES actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_OPCIONES actions', async () => {
      const arg = 42666;
