...
import reducer, {
  ...
  reset,
  updateEntity,
} from './personalizaciones.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PERSONALIZACIONES_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PERSONALIZACIONES actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PERSONALIZACIONES actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PERSONALIZACIONES actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PERSONALIZACIONES actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PERSONALIZACIONES actions', async () => {
      const arg = 42666;
