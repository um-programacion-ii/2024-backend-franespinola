...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CARACTERISTICAS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CARACTERISTICAS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CARACTERISTICAS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_CARACTERISTICAS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_CARACTERISTICAS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CARACTERISTICAS actions', async () => {
      const arg = 42666;
