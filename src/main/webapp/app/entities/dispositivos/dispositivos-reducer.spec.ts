...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DISPOSITIVOS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DISPOSITIVOS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DISPOSITIVOS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_DISPOSITIVOS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_DISPOSITIVOS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DISPOSITIVOS actions', async () => {
      const arg = 42666;
